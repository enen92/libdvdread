...
# define DVDcss_open(a,b) dvdcss_open((char*)(a), (dvdcss_stream_cb*)(b))
...
static dvdcss_t (*DVDcss_open)  (const char *, dvdcss_stream_cb *);
                            ...
                            dvd_reader_stream_cb *stream_cb)
{
  ...
  if(target)
      dev->dvdcss = DVDcss_open(target, (dvdcss_stream_cb *)stream_cb);
...
#define U_S
    ...
    DVDcss_open = (dvdcss_t (*)(const char*, dvdcss_stream_cb *))
